...
import { verifyTeamMember } from "../middleware/verifyTeamMember";
...
// Chat routes (protected by verifyTeamMember middleware)
router.post("/:teamId/messages", verifyTeamMember, sendMessage);
router.get("/:teamId/messages", verifyTeamMember, getMessages);
